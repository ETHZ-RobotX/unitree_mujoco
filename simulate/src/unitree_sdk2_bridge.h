...
public:
    ...
    : mj_model_(model), mj_data_(data), sim_mtx_(sim_mtx)
    {
        ...
        // Initialize Lidar Raycasting Buffers
        // Order: { Vertical (Elevation), Horizontal (Azimuth Offset) }
        struct { double elev; double az_offset; } channel_calib_[128] = {
            { -4.43 * M_PI/180.0,  -1.08 * M_PI/180.0 }, // ch 1
            { -3.50 * M_PI/180.0,  -9.71 * M_PI/180.0 }, // ch 2
            { -2.55 * M_PI/180.0,  -1.09 * M_PI/180.0 }, // ch 3
            { -1.65 * M_PI/180.0,  -9.71 * M_PI/180.0 }, // ch 4
            { -0.75 * M_PI/180.0,  -1.10 * M_PI/180.0 }, // ch 5
            {  0.13 * M_PI/180.0,  -9.72 * M_PI/180.0 }, // ch 6
            {  0.99 * M_PI/180.0,  -1.12 * M_PI/180.0 }, // ch 7
            {  1.85 * M_PI/180.0,  -9.73 * M_PI/180.0 }, // ch 8
            {  2.64 * M_PI/180.0,   2.69 * M_PI/180.0 }, // ch 9
            {  3.46 * M_PI/180.0,  11.33 * M_PI/180.0 }, // ch 10
            {  4.29 * M_PI/180.0,   2.68 * M_PI/180.0 }, // ch 11
            {  5.09 * M_PI/180.0,  11.34 * M_PI/180.0 }, // ch 12
            {  5.91 * M_PI/180.0,   2.68 * M_PI/180.0 }, // ch 13
            {  6.69 * M_PI/180.0,  11.36 * M_PI/180.0 }, // ch 14
            {  7.49 * M_PI/180.0,   2.68 * M_PI/180.0 }, // ch 15
            {  8.25 * M_PI/180.0,  11.39 * M_PI/180.0 }, // ch 16
            {  9.08 * M_PI/180.0,  -1.19 * M_PI/180.0 }, // ch 17
            {  9.84 * M_PI/180.0,  -9.92 * M_PI/180.0 }, // ch 18
            { 10.59 * M_PI/180.0,  -1.21 * M_PI/180.0 }, // ch 19
            { 11.34 * M_PI/180.0,  -9.98 * M_PI/180.0 }, // ch 20
            { 12.08 * M_PI/180.0,  -1.22 * M_PI/180.0 }, // ch 21
            { 12.81 * M_PI/180.0, -10.04 * M_PI/180.0 }, // ch 22
            { 13.54 * M_PI/180.0,  -1.24 * M_PI/180.0 }, // ch 23
            { 14.26 * M_PI/180.0, -10.11 * M_PI/180.0 }, // ch 24
            { 15.11 * M_PI/180.0,   2.50 * M_PI/180.0 }, // ch 25
            { 15.83 * M_PI/180.0,  11.47 * M_PI/180.0 }, // ch 26
            { 16.53 * M_PI/180.0,   2.51 * M_PI/180.0 }, // ch 27
            { 17.23 * M_PI/180.0,  11.56 * M_PI/180.0 }, // ch 28
            { 17.93 * M_PI/180.0,   2.52 * M_PI/180.0 }, // ch 29
            { 18.62 * M_PI/180.0,  11.65 * M_PI/180.0 }, // ch 30
            { 19.31 * M_PI/180.0,   2.54 * M_PI/180.0 }, // ch 31
            { 19.99 * M_PI/180.0,  11.75 * M_PI/180.0 }, // ch 32
            { 20.71 * M_PI/180.0,  -1.33 * M_PI/180.0 }, // ch 33
            { 21.38 * M_PI/180.0, -10.60 * M_PI/180.0 }, // ch 34
            { 22.07 * M_PI/180.0,  -1.35 * M_PI/180.0 }, // ch 35
            { 22.73 * M_PI/180.0, -10.71 * M_PI/180.0 }, // ch 36
            { 23.42 * M_PI/180.0,  -1.37 * M_PI/180.0 }, // ch 37
            { 24.07 * M_PI/180.0, -10.84 * M_PI/180.0 }, // ch 38
            { 24.76 * M_PI/180.0,  -1.39 * M_PI/180.0 }, // ch 39
            { 25.40 * M_PI/180.0, -10.97 * M_PI/180.0 }, // ch 40
            { 26.06 * M_PI/180.0,   2.64 * M_PI/180.0 }, // ch 41
            { 26.73 * M_PI/180.0,  12.39 * M_PI/180.0 }, // ch 42
            { 27.39 * M_PI/180.0,   2.67 * M_PI/180.0 }, // ch 43
            { 28.05 * M_PI/180.0,  12.55 * M_PI/180.0 }, // ch 44
            { 28.71 * M_PI/180.0,   2.70 * M_PI/180.0 }, // ch 45
            { 29.35 * M_PI/180.0,  12.71 * M_PI/180.0 }, // ch 46
            { 30.02 * M_PI/180.0,   2.73 * M_PI/180.0 }, // ch 47
            { 30.66 * M_PI/180.0,  12.89 * M_PI/180.0 }, // ch 48
            { 31.37 * M_PI/180.0,  -1.51 * M_PI/180.0 }, // ch 49
            { 32.05 * M_PI/180.0, -11.77 * M_PI/180.0 }, // ch 50
            { 32.68 * M_PI/180.0,  -1.54 * M_PI/180.0 }, // ch 51
            { 33.34 * M_PI/180.0, -11.96 * M_PI/180.0 }, // ch 52
            { 33.99 * M_PI/180.0,  -1.57 * M_PI/180.0 }, // ch 53
            { 34.63 * M_PI/180.0, -12.15 * M_PI/180.0 }, // ch 54
            { 35.29 * M_PI/180.0,  -1.60 * M_PI/180.0 }, // ch 55
            { 35.92 * M_PI/180.0, -12.36 * M_PI/180.0 }, // ch 56
            { 36.56 * M_PI/180.0,   2.94 * M_PI/180.0 }, // ch 57
            { 37.23 * M_PI/180.0,  13.96 * M_PI/180.0 }, // ch 58
            { 37.86 * M_PI/180.0,   2.98 * M_PI/180.0 }, // ch 59
            { 38.51 * M_PI/180.0,  14.21 * M_PI/180.0 }, // ch 60
            { 39.15 * M_PI/180.0,   3.04 * M_PI/180.0 }, // ch 61
            { 39.79 * M_PI/180.0,  14.48 * M_PI/180.0 }, // ch 62
            { 40.45 * M_PI/180.0,   3.09 * M_PI/180.0 }, // ch 63
            { 41.07 * M_PI/180.0,  14.76 * M_PI/180.0 }, // ch 64
            { 41.78 * M_PI/180.0,  -1.77 * M_PI/180.0 }, // ch 65
            { 42.47 * M_PI/180.0, -13.62 * M_PI/180.0 }, // ch 66
            { 43.08 * M_PI/180.0,  -1.80 * M_PI/180.0 }, // ch 67
            { 43.75 * M_PI/180.0, -13.91 * M_PI/180.0 }, // ch 68
            { 44.37 * M_PI/180.0,  -1.85 * M_PI/180.0 }, // ch 69
            { 45.02 * M_PI/180.0, -14.22 * M_PI/180.0 }, // ch 70
            { 45.67 * M_PI/180.0,  -1.89 * M_PI/180.0 }, // ch 71
            { 46.29 * M_PI/180.0, -14.55 * M_PI/180.0 }, // ch 72
            { 46.93 * M_PI/180.0,   3.44 * M_PI/180.0 }, // ch 73
            { 47.65 * M_PI/180.0,  16.55 * M_PI/180.0 }, // ch 74
            { 48.23 * M_PI/180.0,   3.53 * M_PI/180.0 }, // ch 75
            { 48.91 * M_PI/180.0,  16.98 * M_PI/180.0 }, // ch 76
            { 49.53 * M_PI/180.0,   3.62 * M_PI/180.0 }, // ch 77
            { 50.18 * M_PI/180.0,  17.43 * M_PI/180.0 }, // ch 78
            { 50.82 * M_PI/180.0,   3.72 * M_PI/180.0 }, // ch 79
            { 51.44 * M_PI/180.0,  17.92 * M_PI/180.0 }, // ch 80
            { 52.17 * M_PI/180.0,  -2.14 * M_PI/180.0 }, // ch 81
            { 52.84 * M_PI/180.0, -16.65 * M_PI/180.0 }, // ch 82
            { 53.47 * M_PI/180.0,  -2.20 * M_PI/180.0 }, // ch 83
            { 54.11 * M_PI/180.0, -17.16 * M_PI/180.0 }, // ch 84
            { 54.78 * M_PI/180.0,  -2.26 * M_PI/180.0 }, // ch 85
            { 55.38 * M_PI/180.0, -17.70 * M_PI/180.0 }, // ch 86
            { 56.09 * M_PI/180.0,  -2.33 * M_PI/180.0 }, // ch 87
            { 56.66 * M_PI/180.0, -18.30 * M_PI/180.0 }, // ch 88
            { 57.36 * M_PI/180.0,   4.37 * M_PI/180.0 }, // ch 89
            { 58.11 * M_PI/180.0,  21.24 * M_PI/180.0 }, // ch 90
            { 58.68 * M_PI/180.0,   4.54 * M_PI/180.0 }, // ch 91
            { 59.37 * M_PI/180.0,  22.06 * M_PI/180.0 }, // ch 92
            { 60.00 * M_PI/180.0,   4.73 * M_PI/180.0 }, // ch 93
            { 60.64 * M_PI/180.0,  22.96 * M_PI/180.0 }, // ch 94
            { 61.33 * M_PI/180.0,   4.93 * M_PI/180.0 }, // ch 95
            { 61.90 * M_PI/180.0,  23.96 * M_PI/180.0 }, // ch 96
            { 62.71 * M_PI/180.0,  -2.77 * M_PI/180.0 }, // ch 97
            { 63.44 * M_PI/180.0, -22.52 * M_PI/180.0 }, // ch 98
            { 64.06 * M_PI/180.0,  -2.88 * M_PI/180.0 }, // ch 99
            { 64.72 * M_PI/180.0, -23.61 * M_PI/180.0 }, // ch 100
            { 65.41 * M_PI/180.0,  -3.01 * M_PI/180.0 }, // ch 101
            { 66.00 * M_PI/180.0, -24.83 * M_PI/180.0 }, // ch 102
            { 66.78 * M_PI/180.0,  -3.15 * M_PI/180.0 }, // ch 103
            { 67.29 * M_PI/180.0, -26.20 * M_PI/180.0 }, // ch 104
            { 68.10 * M_PI/180.0,   6.43 * M_PI/180.0 }, // ch 105
            { 69.12 * M_PI/180.0,  32.52 * M_PI/180.0 }, // ch 106
            { 69.49 * M_PI/180.0,   6.87 * M_PI/180.0 }, // ch 107
            { 70.36 * M_PI/180.0,  34.78 * M_PI/180.0 }, // ch 108
            { 70.89 * M_PI/180.0,   7.39 * M_PI/180.0 }, // ch 109
            { 71.58 * M_PI/180.0,  37.40 * M_PI/180.0 }, // ch 110
            { 72.32 * M_PI/180.0,   8.01 * M_PI/180.0 }, // ch 111
            { 72.77 * M_PI/180.0,  40.46 * M_PI/180.0 }, // ch 112
            { 73.88 * M_PI/180.0,  -4.25 * M_PI/180.0 }, // ch 113
            { 75.22 * M_PI/180.0, -41.40 * M_PI/180.0 }, // ch 114
            { 75.36 * M_PI/180.0,  -4.60 * M_PI/180.0 }, // ch 115
            { 76.40 * M_PI/180.0, -45.72 * M_PI/180.0 }, // ch 116
            { 76.87 * M_PI/180.0,  -5.04 * M_PI/180.0 }, // ch 117
            { 77.51 * M_PI/180.0, -50.95 * M_PI/180.0 }, // ch 118
            { 78.41 * M_PI/180.0,  -5.61 * M_PI/180.0 }, // ch 119
            { 78.51 * M_PI/180.0, -57.28 * M_PI/180.0 }, // ch 120
            { 79.62 * M_PI/180.0,  26.63 * M_PI/180.0 }, // ch 121
            { 81.04 * M_PI/180.0,  31.42 * M_PI/180.0 }, // ch 122
            { 82.40 * M_PI/180.0,  38.15 * M_PI/180.0 }, // ch 123
            { 83.64 * M_PI/180.0,  47.90 * M_PI/180.0 }, // ch 124
            { 85.36 * M_PI/180.0,  -6.32 * M_PI/180.0 }, // ch 125
            { 87.02 * M_PI/180.0,  -0.86 * M_PI/180.0 }, // ch 126
            { 88.64 * M_PI/180.0,  18.19 * M_PI/180.0 }, // ch 127
            { 88.99 * M_PI/180.0, 117.30 * M_PI/180.0 }, // ch 128
        };
